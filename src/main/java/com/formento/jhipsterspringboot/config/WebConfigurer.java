...
import com.formento.jhipsterspringboot.web.filter.CachingHttpHeadersFilter;
import com.formento.jhipsterspringboot.web.filter.StaticResourcesProductionFilter;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    private void initClusteredHttpSessionFilter(ServletContext servletContext, EnumSet<DispatcherType> disps) {
        ...
        parameters.put("instance-name", "JhipsterSpringBoot");
